...
import { Crown, User, Mail, Lock, EyeOff, Eye } from 'lucide-react';
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#080b1a] overflow-hidden flex items-center justify-center p-4 z-0">
      ...
      >
        ...
        >
          <img src="/activity.svg" alt="TaskPulse logo" style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
        </div>

        {/* App Name */}
        <div className="text-center">
          <div className="flex items-center justify-center gap-[1px]">
            <span className="font-bold text-2xl text-white">Task</span>
            <span className="font-bold text-2xl text-[#8b5cf6]">Pulse</span>
          </div>
